 ...
 */
 ...
 class ConditionsController extends BaseController{
     ...
     const T_TABLE='items_conditions';
     ...
     public function Del(){
         ...
         foreach ($idArr as $val){
             $exit=M(self::T_ITEMS)->where(array('Itype'=>1,'IsDel'=>0,'_string'=>'FIND_IN_SET('.$val.',ConditIDs)'))->find();
             if($exit){
                 $this->ajaxReturn(0,"该申请条件正在使用中，无法删除");
             }
