 ...
 */
 ...
 class KatypeController extends BaseController{

     const T_TABLE='credit_katype';
     ...
     public function Del(){
         ...
         //如果该材料被使用则无法删除
         $count=M(self::T_ITEMS)->where(array('KatypeID'=>array('in',$idArr),'IsDel'=>0))->count();
         if($count>0){
             $this->ajaxReturn(0,"该卡种正在使用中，无法删除");
         }
