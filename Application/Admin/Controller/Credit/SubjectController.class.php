 ...
 */
 ...
 class SubjectController extends BaseController{
     ...
     public function Del(){
         ...
         //如果该材料被使用则无法删除
         $count=M(self::T_ITEMS)->where(array('SubjectID'=>array('in',$idArr),'IsDel'=>0))->count();
         if($count>0){
             $this->ajaxReturn(0,"该主题正在使用中，无法删除");
         }
