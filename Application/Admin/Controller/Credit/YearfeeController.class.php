 ...
 */
 ...
 class YearfeeController extends BaseController{

     const T_TABLE='credit_yearfee';
     ...
     public function Del(){
         ...
         //如果该材料被使用则无法删除
         $count=M(self::T_ITEMS)->where(array('YearfeeID'=>array('in',$idArr),'IsDel'=>0))->count();
         if($count>0){
             $this->ajaxReturn(0,"该年费正在使用中，无法删除");
         }
