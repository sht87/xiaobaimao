...
<body class="Bodybg">
        ...
        <div id="search" class="search">
            <table border="0" class="SearchTable" cellpadding="3">
                <thead>
                    <tr>
                        <td width="70" align="right">网贷平台：</td>
                        <td width="180">
                            <input id="Title" name="Title" type="text" />
                        </td>
                        <td width="70" align="right">借款类型：</td>
                        <td width="180">
                        ...
                        <td width="70" align="right">金额类型：</td>
                        <td width="180">
                ...
                <tbody id="stbody">
                    <tr>
                        ...
                        <td width="70" align="right">出现高级：</td>
                        <td width="180">
                    ...
                    <tr>
                        <td width="70" align="right">借款期限：</td>
                        <td width="180">
                            <select name="JktimesID" id="JktimesID">
                                <option value="-5">全部</option>
                                <?php if(is_array($jklist)): $i = 0; $__LIST__ = $jklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ID"]); ?>"><?php echo ($vo["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                var columns= [
                    ...
                    { field: 'Isshow', title: '出现的高级', width: 80},
                    { field: 'GoodsNo', title: '平台编码', width: 100 ,sortable: true},
                    { field: 'AppNumbs', title: '申请人数', width: 80 ,sortable: true},
                    { field: 'PassRate', title: '通过率', width: 70,sortable: true },
                    { field: 'DayfeeRate', title: '日费率', width: 70 ,sortable: true},
                    ...
                    { field: 'IsHot', title: '是否热门', width: 80 ,sortable:true,formatter:Common.DoFormatter},
