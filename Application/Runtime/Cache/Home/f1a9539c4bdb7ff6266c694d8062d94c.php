...
<body>
		...
		<!---->
		<section style="padding: 10px 20px; color: #2c2c2c;  margin-top: 50px;text-align: center">
			<section><?php echo ($pages['Title']); ?></section>
			<section><?php echo (substr($pages['AddTime'],0,16)); ?></section>
		</section>
		...
		<!--页面悬浮-->
		<div class="">
			<a href="#"  class="suspend_icon1"><img src="/Public/images/suspend_icon1.png"></a>
			<a href="#" class="suspend_icon2"><img src="/Public/images/suspend_icon2.png"></a>
			<a href="#" class="suspend_icon3"><img src="/Public/images/suspend_icon3.png"></a>
		</div>
		<!--页面悬浮 end-->
		<!---->
		<!--页面悬浮-->
