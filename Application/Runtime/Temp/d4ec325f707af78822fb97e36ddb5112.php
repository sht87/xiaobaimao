<?php
//000000000000s:1428:"<script type='text/javascript'>
function OpenWin(Type) {
   switch (Type) {
        case 'refresh':$.XB.open({ 'type':'refresh','openmode':'2', 'dialog': { 'url': 'refresh/', 'title': '刷新' } });break;
        case 'add':$.XB.open({ 'type':'add','openmode':'0', 'dialog': { 'url': '/admin.php/System/Adcontent/edit/', 'title': '添加' } });break;
        case 'edit':$.XB.open({ 'type':'edit','openmode':'0', 'dialog': { 'url': '/admin.php/System/Adcontent/edit/', 'title': '修改' } });break;
        case 'del':$.XB.open({ 'type':'del','openmode':'3','token': $('input[name=__RequestVerificationToken]').val(), 'dialog': { 'url':'/admin.php/System/Adcontent/del/', 'title': '删除' } });break;
