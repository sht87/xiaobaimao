...
class Demo {
	...
	function __construct($key='5b2e0bd6f43e482dd8000037', $secret='dxbifhkmaz423ww3znibnvdgcfmvgqyd') {
		$this->appkey = $key;
	...
	function sendAndroidUnicast($device_tokens,$msg) {
		try {
			...
			$unicast->setPredefinedKeyValue("title",            $msg);
	...
	function sendIOSUnicast($device_tokens,$msg) {
		try {
