...
use Vendor\XBPayment\AbstractPayer;
use Vendor\XBPayment\HuryUtils;
use Vendor\XBPayment\Request;
...
class Payer extends AbstractPayer
{
    ...
    public function notifyReady()
    {
        ...
        return array(
            ...
            'PayStatus' => $requestData['trade_status'] == 'TRADE_SUCCESS' ? 'S' : 'F',//支付状态 必须 S或者F或者P
        );
    }
